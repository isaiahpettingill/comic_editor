...
namespace AvaloniaColorPicker
{
    ...
    public partial class ColorComponentSelector : UserControl, IColorComponentSelector
    {
        ...
        public ColorComponentSelector()
        {
            ...
            this.FindControl<ToggleButton>("Dim1Toggle").IsCheckedChanged += (s, e) => { if (((ToggleButton)s).IsChecked != true) return; this.ColorComponent = ColorComponents.Component1; };
            this.FindControl<ToggleButton>("Dim2Toggle").IsCheckedChanged += (s, e) => { if (((ToggleButton)s).IsChecked != true) return; this.ColorComponent = ColorComponents.Component2; };
            this.FindControl<ToggleButton>("Dim3Toggle").IsCheckedChanged += (s, e) => { if (((ToggleButton)s).IsChecked != true) return; this.ColorComponent = ColorComponents.Component3; };
        }
